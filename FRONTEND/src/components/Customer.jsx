...
const Customer = ({ customer, getCustomers }) => {
  ...
  return (
    <div className="bg-white rounded-sm shadow-lg overflow-auto">
      ...
      <div className="px-4 pt-2 pb-4">
        ...
        <div className="mt-2 flex gap-4">
          <Link
            ...
            className="inline-block w-full text-center shadow-md text-sm bg-gray-700 text-white rounded-xs px-4 py-1 font-bold hover:bg-gray-600 hover:cursor-pointer"
          >
            Edit
          </Link>
          <button
            onClick={() => deleteCustomer(customer._id)}
            className="inline-block w-full text-center shadow-md text-sm bg-red-700 text-white rounded-xs px-4 py-1 font-bold hover:bg-red-600 hover:cursor-pointer"
          >
            Delete
          </button>
        </div>
