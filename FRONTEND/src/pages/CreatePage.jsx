...
const CreatePage = () => {
    ...
    const saveCustomer = async() => { //ADD VALIDATION TO CHECK FORMAT OF FIELDS ON SAVE BUTTON CLICKED
        ...
        try {
            ...
            {
                companyName: companyName, phoneNumber: phoneNumber, contactName: contactName, companyEmail: companyEmail, image: imageUrl,
                    ...
                    <div>
                        <Collapsible trigger={<Chip label="Contact Info ⤵" size="small" />} open={true}>
                            <div className="block mt-1">
                                ...
                                <input id="nameField" type="text" value={companyName} onChange={(e) => setCompanyName(e.target.value)} onBlur={(e) => validateName(e.target.value)} className="w-3/4 flex ml-7 border p-3 align-center text-gray-600 rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Company Name" />
                            </div>
                            <div>
                                <label className="text-gray-600 mb-2 block font-semibold">Phone Number</label>
                                <input id="phoneField" type="text" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} onBlur={(e) => validateNumber(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600 rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Phone Number" />
                            </div>
                            <div>
                                <label className="text-gray-600 mb-2 block font-semibold">Email</label>
                                <input id="emailField" type="text" value={companyEmail} onChange={(e) => setCompanyEmail(e.target.value)} onBlur={(e) => validateEmail(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600 rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Email" />
                            </div>
                            <div>
                                <label className="text-gray-600 mb-2 block font-semibold">Contact Name</label>
                                <input id="contactField" type="text" value={contactName} onChange={(e) => setContactName(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600  rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Contact Name" />
                            </div>
                            <div>
                                <label className="text-gray-600 mb-2 block font-semibold">Image URL</label>
                                <input type="text" value={image} onChange={(e) => setImage(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600 rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Image URL" />
                            </div>
                        </Collapsible>
                    </div>
                    <div>
                        <Collapsible trigger={<Chip label="Address ⤵" size="small" />}>
                            <div className="mt-1">
                                ...
                                <input type="text" value={streetAddress} onChange={(e) => setStreetAddress(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600  rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Street Address" />
                            </div>
                            <div>
                                <label className="text-gray-600 mb-2 block font-semibold">City</label>
                                <input type="text" value={cityAddress} onChange={(e) => setCityAddress(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600  rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="City" />
                            </div>
                            <div>
                                <label className="text-gray-600 mb-2 block font-semibold">State (Abbrev)</label>
                                <input type="text" value={stateAddress} onChange={(e) => setStateAddress(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600  rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="State" />
                            </div>
                            <div>
                                <label className="text-gray-600 mb-2 block font-semibold">Zip Code</label>
                                <input id="zipCodeField" type="text" value={zipAddress} onChange={(e) => setZipAddress(e.target.value)} onBlur={(e) => validateZipCode(e.target.value)} className="w-3/4 flex ml-7 border p-3 text-gray-600  rounded-sm focus:outline-hidden focus:shadow-outline focus:border-blue-200 placeholder-gray-400" placeholder="Zip Code" />
                            </div>
                        </Collapsible>
                    </div>
                    <div className="flex justify-center">
                        { !isLoading &&  (<button className="block w-1/2 mt-6 bg-blue-700 text-white rounded-xs py-2 font-bold transition ease-in-out duration-300 hover:scale-110 hover:bg-blue-600 hover:cursor-pointer">Save</button>)}
